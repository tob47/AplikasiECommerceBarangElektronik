...
if ($_GET[module]=='store'){
     ...
     echo " 
            </div><div class='profil2'><b>Selamat Datang di Buana Elektronik</b><br />
<p>Kami menyediakan berbagai macam jenis barang-barang elektronik berkualitas tinggi untuk segala kebutuhan anda. Mulai dari TV, Video, Audio, Air Conditioner dan lainnya.
Berkonsep toko elektronik online, kami berusaha memanjakan sekaligus memudahkan para customer untuk berbelanja barang-barang elektronik di toko online kami. Kenyamanan dan keamanan pun kami jaga sehingga tercipta hubungan baik penjual dan pembeli.
...
if ($_GET['module']=='profilkami'){
  ...
  echo "<h4 class='heading colr'>Profil Kami</h4>
          ...
          <div class='profil'>
              <div><p>Buana Elektronik adalah toko elektronik online, yang menyediakan segala kebutuhan barang-barang elektronik anda. Buana elektronik ingin memberikan kemudahan kepada para calon pembeli, cara santai, mudah dan hemat dalam berbelanja barang elektronik berkualias dengan harga yang terjangkau.</p>

<p>Karena itulah website ini dibuat sedemikian sederhananya sehingga diharapkan dapat membantu para pengunjung untuk dapat menelusuri produk-produk yang ditawarkan secara lebih mudah.</p>

<p>Selain melayani pesanan produk-produk yang ada di toko online, kami menerima pembelian secara offline dengan datang ke toko kami yang ada di Jl. Singaparna No.99 Tasikmalaya.</p>

<p>Akhirnya, kami mengucapkan terima kasih atas kunjungan anda di Buana Elektronik.</p></div>
...
elseif ($_GET[module]=='keranjangbelanja'){
  ...
  if($ketemu < 1){
    ...
    echo "<h4 class='heading colr'>Keranjang Belanja</h4>
          ...
          <tbody>
         <tr  background='images/bg_tab.jpg' align=center height=23><th><span class='table'>No</th><th><span class='table'>Produk</th><th><span class='table'>Nama Produk</th><th><span class='table'>Berat(Kg)</th><th><span class='table'>Qty</th>
  ...
  echo "<tr><td colspan=6 align=right><br><span class='table3'>Total:</td><td colspan=2><br><span class='table3'>Rp. $total_rp,-</b></td></tr>
        <tr><td colspan=2><br /><a href=javascript:history.go(-1)><input style='width: 135px; height: 22px;' type=submit  class= simplebtn value='LANJUTKAN BELANJA'></a><br /></td>
        <td colspan=2><br /><input style='width: 130px; height: 22px;' type=submit  class= simplebtn value='UPDATE KERANJANG'><br /></td>
        <td colspan=4 align=right><br /><a href=selesai-belanja.html><input style='width: 115px; height: 22px;' type=submit  class= simplebtn value='SELESAI BELANJA'><br /></td></tr>
        </tbody>
  </table>";
...
$subjek="Pemesanan Online Buana Elektronik";
